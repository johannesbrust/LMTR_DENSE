% This is a script to minimize functions from the CUTEr test set using various
% limited memory trust-region and line-search algorithms based on BFGS update. 
%
% For details, see:
...
CUTEr_init  % initialize CUTEr, see appropriate documentation 
fid =fopen('cuter_list.txt','r');  % read file that contains CUTEr test problems
sfil='TestResults';

function [x,f,outinfo] = LBFGS_MT(fun,x0,params)
% LBFGS_MT - limited memory line-search algorithm L-BFGS based on the
...
% 
% [x,f,outinfo] = LBFGS_MT(fun,x0,params) finds a minimizer x of function defined 
...
% Set parameters for the More-Thuente line search procedure cvsrch
gtolls=0.9;
ftolls=1e-4;
xtolls=1e-16;
maxfev=20;
...
[x,f,g,ns,exls,numfls] = ...
    cvsrch(fun,n,x0,f0,g0,d,1,ftolls,gtolls,xtolls,stpmin,stpmax,maxfev);
numf = numf + numfls;
numg = numg + numfls;
ng=norm(g);
